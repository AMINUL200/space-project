      ...
      <div className="relative z-10 mx-auto max-w-[1400px] px-5 sm:px-8 lg:px-12 xl:px-16">
        ...
        >
          ...
          <p className="mt-7 max-w-[650px] font-inter text-base leading-7 text-text-muted sm:text-lg">
            Whether you want to collaborate, learn more about our missions,
            or become part of the journey, send us a transmission.
          </p>
        </motion.div>
        ...
        <div className="mt-14 grid grid-cols-1 gap-5 lg:mt-20 lg:grid-cols-[0.7fr_1.3fr]">
          ...
          >
            ...
            <h3 className="relative z-10 mt-10 max-w-[400px] font-space-grotesk text-3xl font-medium leading-tight tracking-[-0.035em] text-white sm:text-4xl">
              Let's start
              <br />
              something
              <br />
            ...
            <p className="relative z-10 mt-6 max-w-[380px] font-inter text-sm leading-6 text-text-muted">
              Have a mission in mind? Our team is ready to hear from you and
            ...
            {!submitted ? (
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                  ...
                  <div>
                    <label
                      htmlFor="name"
                      className="mb-2 block font-inter text-[10px] uppercase tracking-[0.16em] text-white/35"
                    >
                      Your Name
                    </label>
                ...
                <div className="flex flex-col gap-4 border-t border-white/10 pt-6 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <p className="max-w-[300px] font-inter text-[10px] leading-5 text-white/25">
                    Your transmission will be securely received by our mission
                    control team.
                  </p>
              ...
              >
                ...
                <p className="mt-4 max-w-[450px] font-inter text-sm leading-6 text-text-muted">
                  Mission control has received your transmission. Our team
